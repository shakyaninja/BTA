...
protected AdapterContact adapterContact;
    ...
    public void generateList(){
        ...
        arrayList.add(new EmergencyContact("Department of Immigration","01-4223509"));
        arrayList.add(new EmergencyContact("Tribhuvan International Airport(TIA)","01-4472256"));
        arrayList.add(new EmergencyContact("Electricity Bhaktapur(Power Failure)","01-6610065"));
        arrayList.add(new EmergencyContact("Ambulance(Bhaktapur Municipality)"," 9851082799"));
        arrayList.add(new EmergencyContact("Ambulance(Siddhi Smriti Hospital)"," 9841204991"));
        arrayList.add(new EmergencyContact("Ambulance(Dr. Iwamura Hospital)","01-6612705"));
        arrayList.add(new EmergencyContact("Ambulance(Bhaktapur Cancer Hospital)"," 9860171552"));
        arrayList.add(new EmergencyContact("Ambulance(Red Cross)"," 9841489408"));
        ...
        arrayList.add(new EmergencyContact("Blood Blank, Kathmandu","01-4229344"));
        arrayList.add(new EmergencyContact("Blood Blank, Bhaktapur","01-6612266"));
