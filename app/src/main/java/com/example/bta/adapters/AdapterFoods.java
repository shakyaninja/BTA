...
public class AdapterFoods extends RecyclerView.Adapter<AdapterFoods.MyHolder> {

    Context context;
    ArrayList<ImageTitle> arrayList;
    public AdapterFoods(Context context, ArrayList<ImageTitle> arrayList) {
    ...
    @NonNull
    @Override
    public AdapterFoods.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterFoods.MyHolder myHolder, int position) {
